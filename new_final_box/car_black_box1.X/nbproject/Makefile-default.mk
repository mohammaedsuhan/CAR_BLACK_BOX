...
FINAL_IMAGE=${DISTDIR}/car_black_box1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=main.c clcd.c matrix_keypad.c adc.c uart.c ds1307.c i2c.c external_EEPROM.c box.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/clcd.p1 ${OBJECTDIR}/matrix_keypad.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/uart.p1 ${OBJECTDIR}/ds1307.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/external_EEPROM.p1 ${OBJECTDIR}/box.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/clcd.p1.d ${OBJECTDIR}/matrix_keypad.p1.d ${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/uart.p1.d ${OBJECTDIR}/ds1307.p1.d ${OBJECTDIR}/i2c.p1.d ${OBJECTDIR}/external_EEPROM.p1.d ${OBJECTDIR}/box.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/clcd.p1 ${OBJECTDIR}/matrix_keypad.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/uart.p1 ${OBJECTDIR}/ds1307.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/external_EEPROM.p1 ${OBJECTDIR}/box.p1

# Source Files
SOURCEFILES=main.c clcd.c matrix_keypad.c adc.c uart.c ds1307.c i2c.c external_EEPROM.c box.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/car_black_box1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/box.p1: box.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/box.p1.d 
	@${RM} ${OBJECTDIR}/box.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/box.p1 box.c 
	@-${MV} ${OBJECTDIR}/box.d ${OBJECTDIR}/box.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/box.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
